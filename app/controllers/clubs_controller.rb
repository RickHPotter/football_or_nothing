...
class ClubsController < ApplicationController
  ...
  def show
    ...
    load_club_overview
    load_club_competition_context
    load_manageable_context if @manageable
    load_club_sidebars
  end
  ...
  def load_club_competition_context
