class AthleteContract < ApplicationRecord
  ...
  has_many :loan_contracts, class_name: "AthleteContract", foreign_key: :parent_athlete_contract_id, dependent: :restrict_with_exception, inverse_of: :parent_athlete_contract
